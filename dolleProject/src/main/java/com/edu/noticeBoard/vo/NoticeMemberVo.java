...
public class NoticeMemberVo {
	...
	public NoticeMemberVo(int noticeIdx, int noticeMemberIdx, String noticeTitle, String noticeContent,
			String noticeFixed, Date noticeCreDate, Date noticeModDate, int memberIdx, String memberName,
	...
	public String toString() {
		return "NoticeMemberVo [noticeIdx=" + noticeIdx + ", noticeMemberIdx=" + noticeMemberIdx + ", noticeTitle="
				...
				+ noticeCreDate + ", noticeModDate=" + noticeModDate + ", memberIdx=" + memberIdx + ", memberName="
				+ memberName + ", memberEmail=" + memberEmail + ", memberNickname=" + memberNickname
