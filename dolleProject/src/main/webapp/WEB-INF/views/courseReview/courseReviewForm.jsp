...
<body>
	...
	<div style="width:1260px; height:1600px; margin:0px auto; background:skyblue">
		...
		<form id="aaa" action="/courseReview/list.do" method="post">
...
<!-- 				<span>별점을 선택해주세요.</span> -->
			...
			<div class="basicBox" style="padding-bottom: 20px;">
				...
				<input id="writeTitle" type="text" placeholder="제목을 입력해주세요." style="width:900px; height:45px; font-size:16px; 
			...
			<div class="basicBox" style="text-align: center;">
				...
				<input class="inputBtn" type="button" onclick="aaa();" value="등록">
