				...
				<table style="width: 610px; height: 740px;">
					...
					<tr>
						...
						<td class="lTdPl20">
							...
							id="fromDt" title="시작일자" onchange="carryStartDateTextToDateFnc();"> ~
							<input type="text" class="input110"
							id="toDt" title="종료일자" onchange="carryEndDateTextToDateFnc();">  
					...
					<tr>
						...
						<td class="lTdPl20">
							<input type="text" class="input110" id="tourStartTime" name="tourStartTime" value="${tourVo.tourStartTime}">
							<span style="margin: 0px 20px;"> ~ </span>
							<input type="text" class="input110" id="tourEndTime" name="tourEndTime" value="${tourVo.tourEndTime}">
						</td>
					</tr>
					<tr>
						<td class="ahreum">투어 최대 인원</td>
						<td class="lTdPl20">
							<input type="number" class="input110" id="tourPeopleNum" name="tourPeopleNum" min="1" value="${tourVo.tourPeopleNum}">
						</td>
					</tr>
					<tr>
						<td class="ahreum">투어 인당 가격</td>
						<td class="lTdPl20">
							<input type="number" class="input110" id="tourPrice" name="tourPrice" min="0" value="${tourVo.tourPrice}">
						</td>
					</tr>
					<tr>
						<td class="ahreum">투어 출발지</td>
						<td class="lTdPl20">
							<input type="text" style="width: 368px;" id="tourStartingPoint" name="tourStartingPoint" value="${tourVo.tourStartingPoint}">
						</td>
					</tr>
					<tr>
						...
						<td class="lTdPl20">
							<textarea id="tourContent" name="tourContent" rows="" cols="" placeholder="내용을 입력해주세요."
						 	...
						 	resize:none; font-family: arial;">${tourVo.tourContent}</textarea>
						</td>
					</tr>
				</table>
			</div>
