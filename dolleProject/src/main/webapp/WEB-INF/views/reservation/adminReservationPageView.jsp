...
<body>
	...
	<div style="width:1260px; height:55px; margin:0 auto;" >
		<h1 class="daehanFont" style="margin: 10px 0px 10px 129px;">가이드 투어 예약페이지 관리</h1>
	</div>
	<c:forEach var="tourVo" items="${tourList}">
		<div style="width: 1000px; height: 360px; border-top: 2px solid #707070; margin: auto; cursor:pointer;" onclick="location.href='../reservation/reservationPageDetail.do?tourNo=${tourVo.tourNo}'">
